...
class PGAgent(nn.Module):
    ...
    def _calculate_q_vals(self, rewards: Sequence[np.ndarray]) -> Sequence[np.ndarray]:
        ...
        if not self.use_reward_to_go:
            ...
            #now its in trajectory form, (n_traj,traj_length,reward)
            ...
            # in trajectory form , each trajectory is a sequence of np.ndarray
            for traj_reward in rewards:
                discounted_reward_to_go=self._discounted_reward_to_go(traj_reward)
                q_values.append(np.array(discounted_reward_to_go))
